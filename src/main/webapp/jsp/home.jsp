...
<body>
    ...
    <div class="monster-info">
        ...
        <c:if test="${not empty todayMonster}">
            <img src="${todayMonster.imagePath}" alt="モンスター画像" style="max-width: 200px;">
            <p>モンスター名: ${todayMonster.name}</p>
            <p>HP: ${todayMonster.hp}/255</p>
            <c:if test="${not todayMonster.defeated}">
                <a href="${pageContext.request.contextPath}/battle" class="battle-button">挑戦する</a>
            </c:if>
